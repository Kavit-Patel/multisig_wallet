...
export const MULTISIG_WALLET_PROGRAM_ID = new PublicKey(MultisigWalletIDL.address)

// This is a helper function to get the MultisigWallet Anchor program.
export function getMultisigWalletProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...MultisigWalletIDL, address: address ? address.toBase58() : MultisigWalletIDL.address } as MultisigWallet, provider)
}
